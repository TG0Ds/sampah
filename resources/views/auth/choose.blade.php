...
<div class="bg-white rounded-lg shadow-lg p-8 space-y-6">
    ...
    <a href="{{ route('admin.login') }}" class="block w-full py-4 px-6 border-2 border-gray-200 rounded-lg hover:border-blue-600 hover:bg-blue-50 transition text-center group">
    ...
    <a href="{{ route('warga.login') }}" class="block w-full py-4 px-6 border-2 border-gray-200 rounded-lg hover:border-green-600 hover:bg-green-50 transition text-center group">
