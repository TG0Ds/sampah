...
namespace App\Models {
     ...
     * @property \Illuminate\Support\Carbon $billing_start_date
     * @property int $id
     * @property-read mixed $status
     * @property-read mixed $status_color
     * @property-read \App\Models\User $user
     * @method static \Illuminate\Database\Eloquent\Builder<DataTagihan>|DataTagihan whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataTagihan>|DataTagihan whereBillingStartDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataTagihan>|DataTagihan whereDueDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataTagihan>|DataTagihan wherePaidDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataTagihan>|DataTagihan whereTotalAmount($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataTagihan>|DataTagihan whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataTagihan>|DataTagihan whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataTagihan>|DataTagihan whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DataTagihan>|DataTagihan newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<DataTagihan>|DataTagihan newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<DataTagihan>|DataTagihan query()
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<DataTagihan>|DataTagihan timeout(int $seconds)
     ...
     */
    class DataTagihan extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereRt($value)
